  ...
  return (
    <section className="center my-8 p-8 rounded-md w-full">
      ...
      <div className="w-full flex justify-around mt-10 gap-12 max-w-7xl">
        <div className="bg-very-light-blue border-light-blue border-2 p-12 rounded-md flex flex-col w-full gap-8">
        ...
        <div className="bg-very-light-pink border-light-pink border-2 p-12 rounded-md flex flex-col w-full gap-8">
        ...
        <div className="border-menta bg-light-menta border-2 p-12 rounded-md flex flex-col w-full gap-8">
